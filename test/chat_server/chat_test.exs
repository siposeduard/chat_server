defmodule ChatServer.ChatTest do
  ...
  describe "chat_conversations" do
    alias ChatServer.Chat.Conversation
  ...
  describe "chat_conversation_members" do
    alias ChatServer.Chat.ConversationMember
  ...
  describe "chat_message_reactions" do
    alias ChatServer.Chat.MessageReaction
  ...
  describe "chat_seen_messages" do
    alias ChatServer.Chat.SeenMessage
